...
- Use ||| para separar parágrafos dentro de cada interpretacao
- Cada interpretacao: 3 partes separadas por |||:
  PARTE 1: Significado e símbolos desta carta no Tarô e Registros Akáshicos
  PARTE 2: Como esta energia afeta ${firstName} nesta posição em relação a "${perguntaReal}"
  PARTE 3: Mensagem e conselho direto dos Guardiões para ${firstName}

{"titulo":"titulo poetico","cartas":[{"posicao":"nome da posicao","carta":"nome da carta","invertida":false,"interpretacao":"parte1|||parte2|||parte3"}],"sintese":"padrao geral|||verdade central para ${firstName}|||caminho indicado","acao_sagrada":"acao concreta para ${firstName} nos proximos 7 dias"}`;
