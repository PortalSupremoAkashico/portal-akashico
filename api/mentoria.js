...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (gender === 'Masculino') genderTreatment = `Trate no masculino.`;
    if (gender === 'Feminino')  genderTreatment = `Trate no feminino.`;
...
4. INTEGRAÇÃO DE SABERES
   ...
   REGRA: MÁXIMO 2 NOMES por resposta completa. Prefira trazer o PENSAMENTO sem o nome — "a neurociência mostra que...", "os místicos descreveram...", "a física quântica revela..." são mais elegantes que uma lista de autores. VARIE sempre entre respostas ao mesmo consulente.
