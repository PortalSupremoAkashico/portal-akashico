// VERSÃO B: fable (dramático, narrativo, misterioso)
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const response = await fetch('https://api.openai.com/v1/audio/speech', {
      ...
      body: JSON.stringify({
        model: 'tts-1-hd',   // HD = qualidade superior
        voice: 'fable',       // dramático, narrativo, britânico
        input: cleanText,
        speed: 0.85,           // lento mas não pesado demais
        response_format: 'mp3'
      })
    });
