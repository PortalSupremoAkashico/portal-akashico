...
export default async function handler(req, res) {
  ...
  if (req.method === 'GET') {
    ...
    const result = await supabaseFetch(
      `/mentorias?email=eq.${encodeURIComponent(email)}&order=created_at.asc&select=id,role,content,consulta_tema,consulta_pergunta,created_at`,
      { method: 'GET' }
    );
